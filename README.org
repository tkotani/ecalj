...
Its one-body part is developed based on the LMTO part of Questaal at https://lordcephei.github.io/.
...
Especially, [[file:Document/Manual/ecaljmanual.pdf][ecaljmanual.pdf]] is the main manual
In addition, we are going to organize [[file:Document/Manual/CategoryAndToken.org][Document/Manual/CategoryAndToken.org]] which explain
switches in ctrl file.
...
It is instractive to reproduce samples in [[Document/deguchi2016.pdf][Document/deguchi2016.pdf]].
We can set up a template ctrl file for your calculation. Ask us.
...
NOTE: If you like to skip steps (1)-(3),  run ./job_materials.py Si at /home/takao/ecalj/MATERIALS.
 >cd Si
 >cp ../syml.si
 >job_band_nspin1 si
...
See [[file:Document/GdQSGW4.pdf][Document/GdQSGW4.pdf]]

* GaussianFilterX0.
This switch in GWinput is very useful and promising (probably) 
...
** For 4f, we need modification to GWinput.tmp
   See [[./Document/GdQSGW4.pdf][./Document/GdQSGW4.pdf]].
