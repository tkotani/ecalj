subroutine besslggg(y,lmax,phi,psi)
  !! we will need to merge this with bessl in besslr.F.
  !  patched to take care of case lmax=1
  !  07.06.91  df floated, to make subroutine work for large lmax's
  implicit real*8 (a-h,p-z), integer(o)
  implicit integer (i-n)
  dimension phi(*),psi(*),dum(420)
  doubleprecision t,dt,t1,tol,my,dt1,dt2
  integer :: tlp1,tmp1,tmp2,lmax,l
  lmux=max0(lmax,2)
  if(lmux > 16) goto 8
  tol=1.d-8
  my=-y
