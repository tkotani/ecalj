...
module m_eibz 
  ...
  use m_genallcf_v3,only: Genallcf_v3, natom,nspin,nl,nn, nlnmx, nctot, alat, deltaw,clabl, plat, pos, ecore
  ...
  !use m_readhbe,only: Readhbe, nprecb,mrecb,mrece,nqbzt,nband,mrecg
