...
10 enddo
  !     pl1=alat*dsqrt(plat1(1,1)**2+plat1(2,1)**2+plat1(3,1)**2)
  !     pl2=alat*dsqrt(plat1(1,2)**2+plat1(2,2)**2+plat1(3,2)**2)
  !     pl3=alat*dsqrt(plat1(1,3)**2+plat1(2,3)**2+plat1(3,3)**2)
  ...
  do   k1 = 0, n1-1
     do   k2 = 0, n2-1
        do   k3 = 0, n3-1
           ...
           !        if (abs(gs(1)+7) .lt. tol .and. abs(gs(2)+1) .lt. tol) then
           !          print *, gs
           !        endif
