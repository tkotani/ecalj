...
(表・プロットとも `mlo_method = 4` の実測。既存 method の結果は不変で、
原本設定 11 系を再実行してバイト単位で一致することを確認済み。)
...
$\Delta=0.18$ 固定で $w$ を振り、方向ごとに最小を与える $w$(括弧内はそこでの値):

| 系 | 窓内 ΔE | 占有側 ΔE | 分散 Δv/v | ギャップ | $m^*$ |
|---|---|---|---|---|---|
| Fe (9) 金属 | 0.80 (0.0052) | 0.80 (0.0045) | 0.80 (0.0118) | — | — |
| Cu (9) 金属 | 0.80 (0.0085) | 0.80 (0.0027) | 0.80 (0.0274) | — | — |
| RuO₂ (26) 金属 | 0.13 (0.0081) | 0.20 (0.0095) | 0.13 (0.0298) | — | — |
| Si $8^3$ (19) 絶縁 | 0.13 (0.0057) | 0.20 (0.0028) | 0.15 (0.0051) | 0.15 (0.0022) | 0.20 (0.0016) |
| GaAs (19) 絶縁 | 0.13 (0.0074) | 0.15 (0.0015) | 0.15 (0.0082) | 0.10 (0.0009) | 0.15 (0.0176) |
| Al₂O₃:Cr (53) 絶縁 | 0.15 (0.0067) | 0.15 (0.0022) | 0.15 (0.0031) | 0.13 (0.0006) | 0.13 (0.0306) |
| C.sp (8) 絶縁 | 0.20 (0.0149) | 0.25 (0.0027) | 0.25 (0.0052) | 0.25 (0.0039) | 0.30 (0.1894) |

**系の中では方向はよく揃う**($\pm0.05$ 以内)。割れるのは**系をまたいだとき**で、
Fe・Cu の 0.80 と半導体の 0.13–0.20 は 6 倍違う。したがって系ごとの $w$ 最適化は
...
既定は $\Delta=0.18$ Ry、$w=0.20$ Ry。全系にそのまま使えるが最適ではない。
半導体を主に扱うなら $w\simeq0.15$、Fe・Cu のような単原子遷移金属なら
$w\simeq0.8$ が良い。$\Delta$ と $w$ は独立ではなく、重みが 1 のままでいる領域の上端が
およそ $e^{\rm cut}-2w=\varepsilon_{\rm CBM}+\Delta-2w$ なので一部打ち消し合う。
2 次元を総当たりする必要は薄く、$\Delta$ を固定した $w$ の 1 次元で足りる。
