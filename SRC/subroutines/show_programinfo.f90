...
subroutine show_programinfo(io)
  ...
  character(256):: PF=""
  character(256):: LL=""
  character(512):: GC1="commit 03addb210394abdf2631efa689bcdff3e2fe07a9"
  character(512):: GC2="Author: Takao Kotani <takaokotani@gmail.com>"
  character(512):: GC3="Date:   Fri Mar 8 14:17:46 2024 +0900"
  ...
  write(io,'(a,a,a)') info,'linked at ',trim("Fri Mar  8 16:59:40 JST 2024")
