...
m_qplist_qspdivider: rank,(iqini,ispini),(iqend,ispend)=    2, (    5    1),  (    6 6)
m_qplist_qspdivider: rank,(iqini,ispini),(iqend,ispend)=    1, (    3    1),  (    4 4)
m_qplist_qspdivider: rank,(iqini,ispini),(iqend,ispend)=    3, (    7    1),  (    8 8)
 ...
 smooth rhoves      2.063911   charge     2.661718
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      201254  -4.9989572696653686E-004
 smvxcm: enforce positive smrho_w. Add srshift=   4.9989572697653690E-004
 ...
 ilm                   rho*vtrue                              rho*vsm
   ...
   1     -10.261804   -3.876233  -14.138038     -2.842621   -0.891814   -3.734435
 ...
 val mom:        1.810990       1.143831       0.667160    core:  -0.000000
 ...
 bndfp: kpt     2 of     8 k=  0.1250  0.1250 -0.1250 ndimh = nmto+napw =     8    8    0
 ... Done MPI k-loop: elapsed time=   0.9134
...
Generating TDOS: efermi, and dos window=   -0.8248  -0.5000   0.6752
 ...
 mkrout:  Qtrue      sm,loc       local        true mm   smooth mm    local mm
   1    2.130156  386.510555 -384.380399     -0.144414 -327.846612  327.702198
 ...
 spn 2 0    0.000012   -1.345454    3.180000    3.101060    3.147584    3.147584
 ...
 srhov:  -1237.408135   1225.635247    -11.772888 sumev=   -3.277726   sumtv=    8.495162

 Energy for background charge q=1, radius r=6.204 :  E = 9/5*q*q/r = 0.2902

 rhomom:   ib   ilm      qmom        Qval       Qc        Z
            1     1 -108.431709 -384.380399     2.00     6.00
 ...
 smooth rhoves     38.909182   charge   388.380399
 smvxcm: all smrho_w is positive
 smooth rhoeps =-2470.310653 (-179.107603,***********)
         rhomu =-3278.859206 (-116.221782,***********)
 ...
 ilm                   rho*vtrue                              rho*vsm
             spin1       spin2       tot           spin1       spin2       tot
   1      -5.572123   -5.624673  -11.196796    -82.114229-2616.757701-2698.871930

 local terms:     true           smooth         local
 rhoeps:        -7.980819   -2470.064621    2462.083802
 rhomu:         -5.216693    -116.220430     111.003737
 spin2:         -5.294318   -3162.319047    3157.024729
 total:        -10.511011   -3278.539477    3268.028467
 val*vef       -11.196796   -3195.937101    3184.740305
 val chg:        2.130156     386.510555    -384.380399
 val mom:       -0.144414    -327.846612     327.702198    core:  -0.000000
 core chg:       2.000000       2.000000       0.000000
 ...
 Energy terms:             smooth           local           total
   rhoval*vef          -2698.892652      2687.560602       -11.332050
   rhoval*ves             82.992193       -91.768733        -8.776540
   psnuc*ves              -5.173830      -258.804129      -263.977959
   utot                   38.909182      -175.286431      -136.377249
   rho*exc             -2470.310653      2462.083802        -8.226851
   rho*vxc             -3278.859206      3268.028467       -10.830739
 ...
 mag. mom=    -1.000000
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      201254  -4.9989874524956446E-004
 smvxcm: enforce positive smrho_w. Add srshift=   4.9989874525956449E-004
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      201254  -4.9989270868350938E-004
 smvxcm: enforce positive smrho_w. Add srshift=   4.9989270869350941E-004
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      201254  -4.9989572696653697E-004
 smvxcm: enforce positive smrho_w. Add srshift=   4.9989572697653700E-004
...
Forces:
 ...
 mixrho: add corrections to qcell smrho =  0.34895D-07  0.17448D-10
...
h zbak=1 mmom=-1.0000001 ehf=-.7541781 ehk=1.8195343
 ...
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      162446  -6.7713819107303997E-004
 smvxcm: enforce positive smrho_w. Add srshift=   6.7713819108304000E-004
 smooth rhoeps = -987.886458 ( -73.662014,-914.224444)
         rhomu =-1310.095944 ( -49.167918,***********)
 ...
 ilm                   rho*vtrue                              rho*vsm
             spin1       spin2       tot           spin1       spin2       tot
   1      -8.282610   -4.877596  -13.160206    -55.594945-1311.702004-1367.296950

 local terms:     true           smooth         local
 rhoeps:        -8.864856    -987.434254     978.569398
 rhomu:         -6.359894     -48.963790      42.603897
 spin2:         -5.306301   -1260.544173    1255.237872
 total:        -11.666195   -1309.507963    1297.841768
 val*vef       -13.160206   -1293.661843    1280.501637
 val chg:        3.128514     194.649572    -191.521059
 val mom:        0.833288    -163.351390     164.184679    core:  -0.000000
 core chg:       2.000000       2.000000       0.000000
  ibas l=  1  0 pnu(1:nsp) pnz(1:nsp)=   2.89128   2.74142   0.00000   0.00000
  ibas l=  1  1 pnu(1:nsp) pnz(1:nsp)=   2.85000   2.85000   0.00000   0.00000
  ibas l=  1  2 pnu(1:nsp) pnz(1:nsp)=   3.14758   3.14758   0.00000   0.00000
 ...
 l,E        a      <phi phi>       a*D        a*Ddot      phi(a)      phip(a)
 0      3.000000    1.000000    -2.842556    8.735618    0.149589   -0.577371
 ...
 Energy terms:             smooth           local           total
   rhoval*vef          -1367.410359      1354.106744       -13.303615
   rhoval*ves             15.851667       -25.851346        -9.999679
   psnuc*ves               1.537274      -268.894255      -267.356981
   utot                    8.694471      -147.372801      -138.678330
   rho*exc              -987.886458       978.569398        -9.317060
   rho*vxc             -1310.095944      1297.841768       -12.254176
 ...
 bndfp: kpt     2 of     8 k=  0.1250  0.1250 -0.1250 ndimh = nmto+napw =     8    8    0
 bndfp: kpt     2 of     8 k=  0.1250  0.1250 -0.1250 ndimh = nmto+napw =     8    8    0
 ... Done MPI k-loop: elapsed time=   1.5632
...
Generating TDOS: efermi, and dos window=   -0.6541  -0.5000   0.8459
 ...
 mkrout:  Qtrue      sm,loc       local        true mm   smooth mm    local mm
   1    2.861901    5.816744   -2.954843     -0.908817    0.058786   -0.967603
 ...
 srhov:    -26.126072     12.723636    -13.402436 sumev=   -3.083069   sumtv=   10.319367
 ...
 smooth rhoves      5.079474   charge     6.954842
 smvxcm: all smrho_w is positive
 smooth rhoeps =   -6.266271 (  -3.367044,  -2.899227)
         rhomu =   -8.197704 (  -4.492651,  -3.705053)
 ...
 ilm                   rho*vtrue                              rho*vsm
             spin1       spin2       tot           spin1       spin2       tot
   1      -5.020915   -8.467592  -13.488507    -13.049081  -10.244678  -23.293759

 local terms:     true           smooth         local
 rhoeps:        -8.774720      -6.242230      -2.532490
 rhomu:         -5.220061      -4.487780      -0.732280
 spin2:         -6.330468      -3.678793      -2.651674
 total:        -11.550528      -8.166573      -3.383955
 val*vef       -13.488507     -12.606435      -0.882071
 val chg:        2.861901       5.816744      -2.954843
 val mom:       -0.908817       0.058786      -0.967603    core:   0.000000
 core chg:       2.000000       2.000000       0.000000
  ibas l=  1  0 pnu(1:nsp) pnz(1:nsp)=   2.91558   2.91238   0.00000   0.00000
  ibas l=  1  1 pnu(1:nsp) pnz(1:nsp)=   2.85000   2.85000   0.00000   0.00000
  ibas l=  1  2 pnu(1:nsp) pnz(1:nsp)=   3.14758   3.15223   0.00000   0.00000
  ibas l=  1  3 pnu(1:nsp) pnz(1:nsp)=   4.10242   4.10242   0.00000   0.00000

 Energy terms:             smooth           local           total
   rhoval*vef            -23.310811         9.805231       -13.505580
   rhoval*ves             -4.308561        -6.016766       -10.325327
   psnuc*ves              14.467508      -282.347305      -267.879798
   utot                    5.079474      -144.182036      -139.102562
   rho*exc                -6.266271        -2.532490        -8.798761
   rho*vxc                -8.197704        -3.383955       -11.581659
   valence chg             5.954842        -2.954843         3.000000
 ...
 mag. mom=    -1.000000
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      162446  -6.7714227091500911E-004
 smvxcm: enforce positive smrho_w. Add srshift=   6.7714227092500914E-004
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      162446  -6.7713411123107071E-004
 smvxcm: enforce positive smrho_w. Add srshift=   6.7713411124107074E-004
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      162446  -6.7713819107303986E-004
 smvxcm: enforce positive smrho_w. Add srshift=   6.7713819108303989E-004
...
Forces:
 ...
 mixrho: add corrections to qcell smrho =  0.74632D-07  0.37316D-10
...
i zbak=1 mmom=-.9999999 ehf=.1527211 ehk=.4602763
 ...
 rhomom:   ib   ilm      qmom        Qval       Qc        Z
            1     1  -36.252606 -128.512144     2.00     6.00
 ...
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      159890  -5.5344165994409059E-004
 smvxcm: enforce positive smrho_w. Add srshift=   5.5344165995409062E-004
 smooth rhoeps = -582.769381 ( -46.657434,-536.111947)
         rhomu = -772.367302 ( -32.187611,-740.179691)
 ...
 ilm                   rho*vtrue                              rho*vsm
             spin1       spin2       tot           spin1       spin2       tot
   1      -7.193507   -6.076154  -13.269661    -47.755197 -908.052239 -955.807436

 local terms:     true           smooth         local
 rhoeps:        -8.839687    -582.419485     573.579797
 rhomu:         -5.979621     -32.025173      26.045553
 spin2:         -5.652773    -739.887437     734.234664
 total:        -11.632394    -771.912611     760.280217
 val*vef       -13.269661    -769.576325     756.306664
 ...
 Energy terms:             smooth           local           total
   rhoval*vef           -955.917163       942.524352       -13.392811
   rhoval*ves              2.353685       -12.490430       -10.136745
   psnuc*ves               5.796112      -273.432819      -267.636707
   utot                    4.074898      -142.961624      -138.886726
   rho*exc              -582.769381       573.579797        -9.189584
   rho*vxc              -772.367302       760.280217       -12.087085
   valence chg           131.512144      -128.512144         3.000000
   valence mag          -109.000691       108.999469        -0.001221
   core charge             2.000000         0.000000         2.000000
 ...
 bndfp: kpt     2 of     8 k=  0.1250  0.1250 -0.1250 ndimh = nmto+napw =     8    8    0
 bndfp: kpt     2 of     8 k=  0.1250  0.1250 -0.1250 ndimh = nmto+napw =     8    8    0
 ... Done MPI k-loop: elapsed time=   1.5440
...
Generating TDOS: efermi, and dos window=   -0.6140  -0.5000   0.8860
 ...
 srhov:    -27.800982     14.114356    -13.686627 sumev=   -3.039431   sumtv=   10.647195
 ...
 smooth rhoves      5.376394   charge     7.311529
 smvxcm: all smrho_w is positive
 ...
 local terms:     true           smooth         local
 rhoeps:        -8.823007      -6.910652      -1.912355
 ...
 core chg:       2.000000       2.000000       0.000000
  ibas l=  1  0 pnu(1:nsp) pnz(1:nsp)=   2.91544   2.91502   0.00000   0.00000
  ibas l=  1  1 pnu(1:nsp) pnz(1:nsp)=   2.85000   2.85000   0.00000   0.00000
  ibas l=  1  2 pnu(1:nsp) pnz(1:nsp)=   3.14758   3.14758   0.00000   0.00000
  ibas l=  1  3 pnu(1:nsp) pnz(1:nsp)=   4.10242   4.10242   0.00000   0.00000
 ...
 Energy terms:             smooth           local           total
   ...
   rho*exc                -6.929373        -1.912355        -8.841728
   rho*vxc                -9.073254        -2.565070       -11.638324
   valence chg             6.311529        -3.311529         3.000000
 ...
 mag. mom=     1.000000
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      159890  -5.5344500408721110E-004
 smvxcm: enforce positive smrho_w. Add srshift=   5.5344500409721113E-004
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      159890  -5.5343831580097007E-004
 smvxcm: enforce positive smrho_w. Add srshift=   5.5343831581097010E-004
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      159890  -5.5344165994409059E-004
 smvxcm: enforce positive smrho_w. Add srshift=   5.5344165995409062E-004
...
Forces:
 ...
 mixrho: warning. negative smrho; isp number min=       1   84005 -0.46656D-03
 mixrho: warning. negative smrho; isp number min=       2   72315 -0.46816D-03
 mixrho: add corrections to qcell smrho =  0.22443D-07  0.11222D-10
...
i zbak=1 mmom=.9999999 ehf=.2619417 ehk=.5537104
 ...
 rhomom:   ib   ilm      qmom        Qval       Qc        Z
            1     1  -22.661263  -80.332085     2.00     6.00
 ...
 smooth rhoves      2.855821   charge    84.332085
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      156320  -4.6816419198796570E-004
 smvxcm: enforce positive smrho_w. Add srshift=   4.6816419199796567E-004
 smooth rhoeps = -312.432541 ( -29.626750,-282.805791)
         rhomu = -413.692859 ( -21.973798,-391.719061)
 ...
 ilm                   rho*vtrue                              rho*vsm
             spin1       spin2       tot           spin1       spin2       tot
   1      -8.547285   -4.936333  -13.483617    -40.213895 -563.011224 -603.225119

 local terms:     true           smooth         local
 rhoeps:        -8.871941    -312.154396     303.282455
 rhomu:         -6.396950     -21.821958      15.425008
 spin2:         -5.279730    -391.509656     386.229926
 total:        -11.676680    -413.331614     401.654934
 val*vef       -13.483617    -416.930863     403.447246
 val chg:        3.042073      83.374158     -80.332085
 val mom:        0.875050     -65.578275      66.453325    core:  -0.000000
 core chg:       2.000000       2.000000       0.000000
  ibas l=  1  0 pnu(1:nsp) pnz(1:nsp)=   2.91544   2.91502   0.00000   0.00000
  ibas l=  1  1 pnu(1:nsp) pnz(1:nsp)=   2.85000   2.85000   0.00000   0.00000
  ibas l=  1  2 pnu(1:nsp) pnz(1:nsp)=   3.14758   3.14758   0.00000   0.00000
 ...
 Energy terms:             smooth           local           total
   rhoval*vef           -603.314250       589.736207       -13.578043
   rhoval*ves             -3.564302        -6.725629       -10.289930
   psnuc*ves               9.275943      -277.188925      -267.912982
   utot                    2.855821      -141.957277      -139.101456
   rho*exc              -312.432541       303.282455        -9.150086
   rho*vxc              -413.692859       401.654934       -12.037925
   valence chg            83.332085       -80.332085         3.000000
 ...
 bndfp: kpt     2 of     8 k=  0.1250  0.1250 -0.1250 ndimh = nmto+napw =     8    8    0
 bndfp: kpt     2 of     8 k=  0.1250  0.1250 -0.1250 ndimh = nmto+napw =     8    8    0
 ... Done MPI k-loop: elapsed time=   1.6769
...
Generating TDOS: efermi, and dos window=   -0.6339  -0.5000   0.8661
 ...
 srhov:    -29.460731     15.798496    -13.662234 sumev=   -3.022290   sumtv=   10.639944
 ...
 ilm                   rho*vtrue                              rho*vsm
             spin1       spin2       tot           spin1       spin2       tot
   1      -8.858528   -4.779307  -13.637835    -18.663150   -7.905423  -26.568574

 local terms:     true           smooth         local
 rhoeps:        -8.826208      -7.243729      -1.582479
 rhomu:         -6.423276      -6.933317       0.510041
 spin2:         -5.195012      -2.554573      -2.640438
 total:        -11.618288      -9.487891      -2.130397
 val*vef       -13.637835     -13.535694      -0.102141
 val chg:        2.892764       6.390516      -3.497752
 val mom:        0.955260       2.443426      -1.488166    core:   0.000000
 core chg:       2.000000       2.000000       0.000000
  ibas l=  1  0 pnu(1:nsp) pnz(1:nsp)=   2.91687   2.91418   0.00000   0.00000
  ibas l=  1  1 pnu(1:nsp) pnz(1:nsp)=   2.85000   2.85000   0.00000   0.00000
  ibas l=  1  2 pnu(1:nsp) pnz(1:nsp)=   3.14758   3.14758   0.00000   0.00000
  ibas l=  1  3 pnu(1:nsp) pnz(1:nsp)=   4.10242   4.10242   0.00000   0.00000
 ...
 mag. mom=     1.000000
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      156320  -4.6816702207651983E-004
 smvxcm: enforce positive smrho_w. Add srshift=   4.6816702208651981E-004
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      156320  -4.6816136189941157E-004
 smvxcm: enforce positive smrho_w. Add srshift=   4.6816136190941154E-004
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      156320  -4.6816419198796570E-004
 smvxcm: enforce positive smrho_w. Add srshift=   4.6816419199796567E-004
...
Forces:
 ...
 mixrho: warning. negative smrho; isp number min=       1   64623 -0.25492D-03
 mixrho: warning. negative smrho; isp number min=       2   77697 -0.25984D-03
 mixrho: add corrections to qcell smrho =  0.29885D-07  0.14943D-10
...
i zbak=1 mmom=.9999999 ehf=.301221 ehk=.5529447
 ...
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      142320  -2.5983803336891058E-004
 smvxcm: enforce positive smrho_w. Add srshift=   2.5983803337891056E-004
 ...
 ilm                   rho*vtrue                              rho*vsm
             spin1       spin2       tot           spin1       spin2       tot
   1      -9.905262   -3.871092  -13.776354    -20.089075   -7.191326  -27.280401
 ...
 Energy terms:             smooth           local           total
   ...
   psnuc*ves              14.931733      -283.152103      -268.220370
 ...
 bndfp: kpt     2 of     8 k=  0.1250  0.1250 -0.1250 ndimh = nmto+napw =     8    8    0
 bndfp: kpt     2 of     8 k=  0.1250  0.1250 -0.1250 ndimh = nmto+napw =     8    8    0
 ... Done MPI k-loop: elapsed time=   1.6540
...
Generating TDOS: efermi, and dos window=   -0.6447  -0.5000   0.8553
 ...
 core chg:       2.000000       2.000000       0.000000
  ibas l=  1  0 pnu(1:nsp) pnz(1:nsp)=   2.91943   2.91289   0.00000   0.00000
  ibas l=  1  1 pnu(1:nsp) pnz(1:nsp)=   2.85000   2.85000   0.00000   0.00000
  ibas l=  1  2 pnu(1:nsp) pnz(1:nsp)=   3.14758   3.14758   0.00000   0.00000
  ibas l=  1  3 pnu(1:nsp) pnz(1:nsp)=   4.10242   4.10242   0.00000   0.00000
 ...
 mag. mom=     1.000000
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      142320  -2.5983959190237628E-004
 smvxcm: enforce positive smrho_w. Add srshift=   2.5983959191237625E-004
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      142320  -2.5983647483544489E-004
 smvxcm: enforce positive smrho_w. Add srshift=   2.5983647484544486E-004
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      142320  -2.5983803336891058E-004
 smvxcm: enforce positive smrho_w. Add srshift=   2.5983803337891056E-004
...
Forces:
 ...
 mixrho: warning. negative smrho; isp number min=       1   62895 -0.17369D-03
 mixrho: warning. negative smrho; isp number min=       2   74013 -0.17638D-03
 mixrho: add corrections to qcell smrho =  0.52639D-07  0.26320D-10
...
i zbak=1 mmom=.9999999 ehf=.4380719 ehk=.5523162
 ...
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      136908  -1.7637642793872941E-004
 smvxcm: enforce positive smrho_w. Add srshift=   1.7637642794872941E-004
 ...
 Energy terms:             smooth           local           total
   rhoval*vef            -38.499682        24.745498       -13.754184
 ...
 bndfp: kpt     2 of     8 k=  0.1250  0.1250 -0.1250 ndimh = nmto+napw =     8    8    0
 bndfp: kpt     2 of     8 k=  0.1250  0.1250 -0.1250 ndimh = nmto+napw =     8    8    0
 ... Done MPI k-loop: elapsed time=   1.5752
...
Generating TDOS: efermi, and dos window=   -0.6283  -0.5000   0.8717
 ...
 core chg:       2.000000       2.000000       0.000000
  ibas l=  1  0 pnu(1:nsp) pnz(1:nsp)=   2.92077   2.91684   0.00000   0.00000
  ibas l=  1  1 pnu(1:nsp) pnz(1:nsp)=   2.85000   2.85000   0.00000   0.00000
  ibas l=  1  2 pnu(1:nsp) pnz(1:nsp)=   3.14758   3.14758   0.00000   0.00000
  ibas l=  1  3 pnu(1:nsp) pnz(1:nsp)=   4.10242   4.10242   0.00000   0.00000

 Energy terms:             smooth           local           total
   rhoval*vef            -31.180911        17.502191       -13.678720
 ...
 mag. mom=     1.000000
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      136908  -1.7637748785839981E-004
 smvxcm: enforce positive smrho_w. Add srshift=   1.7637748786839981E-004
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      136908  -1.7637536801905901E-004
 smvxcm: enforce positive smrho_w. Add srshift=   1.7637536802905901E-004
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      136908  -1.7637642793872941E-004
 smvxcm: enforce positive smrho_w. Add srshift=   1.7637642794872941E-004
...
Forces:
 ...
 mixrho: warning. negative smrho; isp number min=       1   60883 -0.15313D-03
 mixrho: warning. negative smrho; isp number min=       2   73677 -0.15570D-03
 mixrho: add corrections to qcell smrho =  0.46825D-07  0.23412D-10
...
i zbak=1 mmom=.9999999 ehf=.4747801 ehk=.5521077
 ...
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      134560  -1.5569732432913405E-004
 smvxcm: enforce positive smrho_w. Add srshift=   1.5569732433913405E-004
 vxcns2 (warning): nr*np=     11808  negative density # of points=         0       416
 vxcns2 (warning): nr*np=     11808  negative density # of points=         0       416
 ...
 ilm                   rho*vtrue                              rho*vsm
             spin1       spin2       tot           spin1       spin2       tot
   1      -9.188023   -4.524534  -13.712557    -20.386695  -12.643953  -33.030649

 local terms:     true           smooth         local
 rhoeps:        -8.871098      -9.051501       0.180403
 rhomu:         -6.545462      -7.626628       1.081167
 spin2:         -5.132063      -4.229964      -0.902099
 ...
 bndfp: kpt     2 of     8 k=  0.1250  0.1250 -0.1250 ndimh = nmto+napw =     8    8    0
 bndfp: kpt     2 of     8 k=  0.1250  0.1250 -0.1250 ndimh = nmto+napw =     8    8    0
 ... Done MPI k-loop: elapsed time=   1.5605
...
Generating TDOS: efermi, and dos window=   -0.6285  -0.5000   0.8715
 ...
 core chg:       2.000000       2.000000       0.000000
  ibas l=  1  0 pnu(1:nsp) pnz(1:nsp)=   2.92114   2.91723   0.00000   0.00000
  ibas l=  1  1 pnu(1:nsp) pnz(1:nsp)=   2.85000   2.85000   0.00000   0.00000
  ibas l=  1  2 pnu(1:nsp) pnz(1:nsp)=   3.14758   3.14758   0.00000   0.00000
  ibas l=  1  3 pnu(1:nsp) pnz(1:nsp)=   4.10242   4.10242   0.00000   0.00000
 ...
 mag. mom=     1.000000
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      134560  -1.5569825938415853E-004
 smvxcm: enforce positive smrho_w. Add srshift=   1.5569825939415854E-004
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      134560  -1.5569638927410959E-004
 smvxcm: enforce positive smrho_w. Add srshift=   1.5569638928410959E-004
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      134560  -1.5569732432913408E-004
 smvxcm: enforce positive smrho_w. Add srshift=   1.5569732433913408E-004
...
i zbak=1 mmom=.9999999 ehf=.4851006 ehk=.5520825
 ...
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      132442  -1.4203276483584811E-004
 smvxcm: enforce positive smrho_w. Add srshift=   1.4203276484584811E-004
 smooth rhoeps =   -9.004061 (  -5.558439,  -3.445623)
         rhomu =  -11.793055 (  -7.600480,  -4.192574)
 ...
 ilm                   rho*vtrue                              rho*vsm
             spin1       spin2       tot           spin1       spin2       tot
   1      -9.143312   -4.565135  -13.708447    -20.188961  -12.430913  -32.619874
 ...
 l,E        a      <phi phi>       a*D        a*Ddot      phi(a)      phip(a)
 0      3.000000    1.000000   -11.276384    7.712482    0.084653   -0.622091
 ...
 Energy terms:             smooth           local           total
   rhoval*vef            -32.650749        18.911390       -13.739358
   ...
   rho*vxc               -11.793055         0.023804       -11.769251
 ...
 bndfp: kpt     2 of     8 k=  0.1250  0.1250 -0.1250 ndimh = nmto+napw =     8    8    0
 bndfp: kpt     2 of     8 k=  0.1250  0.1250 -0.1250 ndimh = nmto+napw =     8    8    0
 ... Done MPI k-loop: elapsed time=   1.6137
...
Generating TDOS: efermi, and dos window=   -0.6277  -0.5000   0.8723
 ...
 core chg:       2.000000       2.000000       0.000000
  ibas l=  1  0 pnu(1:nsp) pnz(1:nsp)=   2.92138   2.91762   0.00000   0.00000
  ibas l=  1  1 pnu(1:nsp) pnz(1:nsp)=   2.85000   2.85000   0.00000   0.00000
  ibas l=  1  2 pnu(1:nsp) pnz(1:nsp)=   3.14758   3.14758   0.00000   0.00000
  ibas l=  1  3 pnu(1:nsp) pnz(1:nsp)=   4.10242   4.10242   0.00000   0.00000
 ...
 mag. mom=     1.000000
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      132442  -1.4203361763627487E-004
 smvxcm: enforce positive smrho_w. Add srshift=   1.4203361764627488E-004
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      132442  -1.4203191203542134E-004
 smvxcm: enforce positive smrho_w. Add srshift=   1.4203191204542135E-004
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      132442  -1.4203276483584811E-004
 smvxcm: enforce positive smrho_w. Add srshift=   1.4203276484584811E-004
...
Forces:
 ...
 mixrho: warning. negative smrho; isp number min=       2   71037 -0.10695D-03
 mixrho: warning. negative smrho; isp number min=       2   71037 -0.10695D-03
 mixrho: add corrections to qcell smrho =  0.43969D-07  0.21984D-10
...
i zbak=1 mmom=.9999999 ehf=.4916627 ehk=.5520688
 ...
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      126034  -1.0694824057903591E-004
 smvxcm: enforce positive smrho_w. Add srshift=   1.0694824058903591E-004
 ...
 total:        -11.660311     -11.383239      -0.277072
 ...
 Energy terms:             smooth           local           total
   ...
   rho*vxc               -11.459368        -0.277072       -11.736440
 ...
 bndfp: kpt     2 of     8 k=  0.1250  0.1250 -0.1250 ndimh = nmto+napw =     8    8    0
 bndfp: kpt     2 of     8 k=  0.1250  0.1250 -0.1250 ndimh = nmto+napw =     8    8    0
 ... Done MPI k-loop: elapsed time=   1.6205
...
Generating TDOS: efermi, and dos window=   -0.6252  -0.5000   0.8748
 ...
 core chg:       2.000000       2.000000       0.000000
  ibas l=  1  0 pnu(1:nsp) pnz(1:nsp)=   2.92202   2.91864   0.00000   0.00000
  ibas l=  1  1 pnu(1:nsp) pnz(1:nsp)=   2.85000   2.85000   0.00000   0.00000
  ibas l=  1  2 pnu(1:nsp) pnz(1:nsp)=   3.14758   3.14758   0.00000   0.00000
  ibas l=  1  3 pnu(1:nsp) pnz(1:nsp)=   4.10242   4.10242   0.00000   0.00000
 ...
 mag. mom=     1.000000
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      126034  -1.0694888227478209E-004
 smvxcm: enforce positive smrho_w. Add srshift=   1.0694888228478209E-004
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      126034  -1.0694759888328973E-004
 smvxcm: enforce positive smrho_w. Add srshift=   1.0694759889328973E-004
 smvxcm: smrho_w<minimumrho(jun2011) number,min(smrho_w)=      126034  -1.0694824057903591E-004
 smvxcm: enforce positive smrho_w. Add srshift=   1.0694824058903591E-004
...
i zbak=1 mmom=.9999999 ehf=.5080672 ehk=.5520394
 ...
 bndfp: kpt     2 of     8 k=  0.1250  0.1250 -0.1250 ndimh = nmto+napw =     8    8    0
 bndfp: kpt     2 of     8 k=  0.1250  0.1250 -0.1250 ndimh = nmto+napw =     8    8    0
 ... Done MPI k-loop: elapsed time=   1.5674
...
Generating TDOS: efermi, and dos window=   -0.6191  -0.5000   0.8809
 ...
 core chg:       2.000000       2.000000       0.000000
  ibas l=  1  0 pnu(1:nsp) pnz(1:nsp)=   2.92429   2.92197   0.00000   0.00000
  ibas l=  1  1 pnu(1:nsp) pnz(1:nsp)=   2.85000   2.85000   0.00000   0.00000
  ibas l=  1  2 pnu(1:nsp) pnz(1:nsp)=   3.14758   3.14758   0.00000   0.00000
  ibas l=  1  3 pnu(1:nsp) pnz(1:nsp)=   4.10242   4.10242   0.00000   0.00000
...
Forces:
 ...
 mixrho: warning. negative smrho; isp number min=       1   30191 -0.34589D-04
 mixrho: warning. negative smrho; isp number min=       2   58939 -0.35966D-04
 mixrho: add corrections to qcell smrho =  0.43135D-07  0.21568D-10
