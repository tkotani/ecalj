...
Sn  =" atomz=50@ pz=''@ p=''@ eh=-0.1*4@ eh2=-2*3@ R=?@" 
...
#    rlmchk=0
    ...
    metali=3
    fsmom_val=0.0
    touchingratio=1. #default value was -1.0 
    eh1set=1
    for arg in argset:
...
#		readrmt=1
	...
	sys.exit(-1)
    return nspin_val,xcfun_val,xcfun_str,mmom_val,  systype_val,nk_val1,nk_val2,nk_val3,showatomlist,showhelp,metali,fsmom_val,touchingratio,eh1set #rlmchk,r_mul_val,
...
if(showhelp==1):
    print \
""" 
ctrlgenM1.py. tkotani and h.kino jun_2012 version :
---------------
Purpose: 
     Generate a template of ctrl file ctrlgenM1.ctrl.{ext}."
...
try:
    ...
    print '=== Need ctrls file such as ctrls.si.  Run ctrlgenM1 si [options] ==='
    print " Example: ctrlgenM1.py si --nk1=8 --nk2=8 --nk3=8 --tratio=0.9 --insulator "
    sys.exit()
print 
...
tail="""
\n"""
tail = tail+ "% const pwemax=5 nk1="+nk_val1+" nk2="+nk_val2+" nk3="+nk_val3+" nit=30  gmax=12  nspin="+nspin_val+ " metal="+ metali_val +" so=0 xcfun="+xcfun_val+"\n"
