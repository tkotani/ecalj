subroutine potpsr2(z,rmax,lmxa,v,vdif,a,nr,rofi,g,gp,gpp, &
  ...
  !  for phi is pnu=.5-atan(dnu)/pi+(princ.quant.number). scal-rel.
  !m  02.09.94  Potential vdif is included by perturbation.
  !s  02.01.95  spin polarized
  !  make sure g,gp,gpp are big enough... two components.
...
5 enddo
  ...
  !|      write(6,916) v(nr,1),vdif(nr,1)
  !|  916 format(' at rmax: v,vdif=',f10.5,f10.5)
...
699     format(i3,4f12.5,2f12.4)
        ...
        ! ------ make integrals of products of phi,phidot times potential ----
        fllp1 = l*(l+1)
        cc = 274.074d0
        v00 = 0d0
        v10 = 0d0
...
15      enddo
        !|    write(6,290) l,v00,v10,v11
        ! 290 format(' l=',i4,'   vij=',3f12.6)
        !|    write(6,291) l,d00,d10,d11
        ! 291 format(' l=',i4,'   dij=',3f12.6)
        !|    write(6,292) l,v00+d00,v10+d10,v11+d11
        ! 292 format(' l=',i4,'   sum=',3f12.6)
        v00 = v00 + d00
        v10 = v10 + d10
        v11 = v11 + d11
        v01 = v10
