...
% const pwemax=4 nk1=8 nk2=8 nk3=8 nit=30  gmax=12  nspin=1 metal=3 so=0 xcfun=1 ssig=1.0
...
HAM   NSPIN={nspin}   # Set NSPIN=2 for spin-polarize case; then set SPEC_MMOM (initial guess of magnetic polarization).
      ...
      FRZWF=T #If T, fix augmentation function. This is worth to test in future.
