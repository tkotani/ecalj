...
c      write(6,*)' ======== nqibz ngrp ngrp2=',nqibz,ngrp,ngrp2
      do i=1,nqbz
...
c      call checkagree(q1,q1x,' q1 ne q1x')
      if (myproc.eq.0) write(6,"('q1 q1x=',3f9.4,3x,3f9.4)") q1,q1x
...
!! write result 
      do ispin = 1,nspin
         ...
         iti = iko_ixs(ispin)
         itf = iko_fxs(ispin)
c         write(6,*)'wwwwwww', iqbz,ispin,iti,itf
         write(ifpsig) iqbz
