--- this is old memo when we calculatite NiSe (antiferro magnetic)---
I need to recover mmtarget.aftest mode if necessary.




=== QSGW+{B} Memo for NiSe 02jul2021 ===
...
lmf try to find out U values (J=0),
