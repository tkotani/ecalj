...
%const kmxa=7  # =radial degree of freedom to expand eigenfuncitons in tail sites.
...
% const pwemax=5 nk1=20 nk2=20 nk3=20 nit=30  gmax=12  nspin=2 metal=3 so=0 xcfun=1 ssig=1.0
