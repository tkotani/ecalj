...
c      use m_zmel,only:       !NOTE: these data set are stored in this module, and used  
c     & nband
...
c$$$      read(ifi,*) ngrpx
c$$$      allocate(symgg(3,3,ngrp))
c$$$      do ig = 1,ngrp
c$$$        read(ifi,*)
c$$$        do i=1,3
c$$$          read(ifi,*) symgg(i,1:3,ig)
c$$$        enddo
c$$$c        print *,'ssssssss',ig,symgg(:,:,ig)
c$$$      enddo
c$$$  close(ifi)
      call readhamindex()
...
c$$$     i            nwf,ebmx,mtet,eibzmode) !nov2016
