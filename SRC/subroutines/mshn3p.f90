...
471 format(' interpolated moment:  ',3f12.5,'  ->',f11.5)
  ...
  if (lrout > 0) then
     ...
     enddo
     call mshn32(w1,w2,w3,n1,n2,n3,k1,k2,k3,nsp,smrho)! --- Interpolate smooth density ---
     ! --- Interpolate forces ---
     if (lfrce /= 0) then
        do  ib = 1, nbas
           do  m = 1, 3
...
subroutine mshn31(w1,w2,w3,nelt,nsp,qkkl)!- Interpolate coeffs of local density
  implicit none
  integer :: nelt,nsp
...
subroutine mshn32(w1,w2,w3,n1,n2,n3,k1,k2,k3,nsp,smrho)!- Interpolate smooth mesh density
  implicit none
