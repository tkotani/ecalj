...
- **FeMgO** — **空格子球を入れて解決した。**
  ...
  |---|---:|---:|---:|---:|
  | 空格子球なし (9 サイト) | 78 | **126.9** / 73.5 | 6.6 / 6.5 | 0.195 / 0.231 |
  | **空格子球あり (16 サイト)** | 141 | **2.4** / 0.8 | 0.5 / 0.5 | 0.007 / 0.004 |

  (majority / minority、ΔE は meV)。窓内の誤差は **53 分の 1**。
  ...
  残差 37 meV も 1 点(+1.54 eV)に集中しており、空格子球の層数を増やせばさらに減る余地がある。

  実行は kt1(メモリ 251 GB)。ローカルは 14 GB で OOM になる。
