C     For diagonalizing Non-Hermite matrix (2017/09/22, Okumura)
C     For Hermite matrix, use 'diagcv2.F'
...
c      complex*16:: vl,vr       !bugfix (whis was not decleared) jan2013
...
c http://www.netlib.org/lapack/complex16/zgeev.f
c
