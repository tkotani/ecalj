...
#######################
Fe= "  atomz=26@ pz='0,0,4.15'@ p=''@ eh=-0.1*4@ eh2=-2*3@ R=1.00@"
Co= "  atomz=27@ pz='0,0,4.15'@ p=''@ eh=-0.1*4@ eh2=-2*3@ R=1.00@"
Ni= "  atomz=28@ pz='0,0,4.15'@ p=''@ eh=-0.1*4@ eh2=-2*3@ R=1.06@"
Cu= "  atomz=29@ pz='0,0,4.15'@ p=''@ eh=-0.1*4@ eh2=-2*3@ R=1.13@"
