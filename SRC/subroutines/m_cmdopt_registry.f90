...
module m_cmdopt_registry
  ...
  logical, public, protected, save :: c0_keepmixm        = .false.  ! hidden: keep __mixm.<sname> from a previous lmf run (default: deleted at start)
...
contains
  ...
  subroutine load_cmdopt0_registry(narg, arglist)
    ...
    call set0('--keepmixm',       c0_keepmixm, narg, arglist)
