...
CC = cc
#CFLAGS =  -DINTEL_IFC -O3 -funroll-loops -ffast-math -finline -w
CFLAGS =  -DINTEL_IFC  -g
...
FC = mpif90
LK = mpif90
FFLAGS = -O3 -cm -axW -WB  -cpp $(CPP_SW)
FFLAGS_LESS = -O2 -cm -WB  -cpp $(CPP_SW)
FFLAGS_LESS2 = -O1 -cm -WB -cpp $(CPP_SW)
FFLAGS_LESS3 = -O0 -cm -WB -cpp $(CPP_SW)
FFLAGS_NONE = -g -cm -WB   -cpp $(CPP_SW)
...
CPP_SW =   -DF90 -DFFTW -DIN_PLACE -DHASGETARG -DHASNARGS -DFDATE   -DMPI -UMPE 
