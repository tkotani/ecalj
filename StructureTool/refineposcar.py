...
parser.add_argument('--symprec1', type=float, default=3e-3, help='Initial symmetry precision (default: 3e-3)')
parser.add_argument('--symprec2', type=float, default=1e-8, help='Final symmetry precision (default: 1e-8)')
