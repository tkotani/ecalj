...
C ... Setup array iv0 offset of qmom to ibas
      iv0 = 0
      do ib = 1, nbas
        is = ssite(ib)%spec
        lmxl = sspec(is)%lmxl
...
C   ... Multiply factors into gpot0, accumulate force
   ...
   40 continue
      ...
      subroutine pvdf2(nbas,nsp,ssite,sspec,n1,n2,n3,k1,k2,k3, !slat,
...
C ... vxcp = vxc (smrho+drho)
      ...
      call smvxcm(ssite,sspec,nbas,0,k1,k2,k3,smrho, !slat,
