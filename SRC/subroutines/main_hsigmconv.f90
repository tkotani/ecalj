! subroutine hsigmconv()   ! convert sigma to sigm
...
!   ! ... read sigma ASCII format ---------------------------------------
!   ! sigma to sigm
!   !      call headver('hsigmconv: convert sigma to sigm',0)
...
!   close(ifse_out)
!   ! top2rx 2013.08.09 kino 9999 stop ' OK! hsigmconv: convert from sigma to sigm '
...
!   call rwsigma2 (ifse_out,sigma_m,qqqx_m, nspin,ntq,n1,n2,n3,nq,1)
!   close(ifse_out)
!   ! ... write sigm ascii format ---------------------------------------
!   write(6,*)
!   write(6,*) "=== Write sigma to files (ASCII) ========"
!   open(UNIT=ifse_out, file='sigma')
!   call rwsigmaa2 (-ifse_out,sigma_m,qqqx_m, nspin,ntq,n1,n2,n3,nq,1)
!   close(ifse_out)
!   ! top2rx 2013.08.09 kino 9998 stop ' OK! hsigmconv: convert from sigm to sigma '
! 9998 call rx0( ' OK! hsigmconv: convert from sigm to sigma ')
! endsubroutine hsigmconv
...
!   ! cccccccccccccccccccccccdddddddddddddddddccccc
...
!      endif
!   enddo
!   !      write(6,'(" Not Find q in list q=",3f13.5)')q
!   qlistchk=.false.
! end function qlistchk
