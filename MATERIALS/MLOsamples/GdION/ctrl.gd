...
SYMGRP r4z    # 'find' evaluate space-group symmetry (just from lattice) automatically.
              #
...
%const bohr=0.529177 a= 10.0/bohr
STRUC
     ALAT={a}
     ...
     NL=4  NBAS= 1  NSPEC=1
SITE
     ATOM=Gd POS=  0.0   0.0 0.0
SPEC
    ATOM=Gd Z=64 R=3.00    
      EH=-1 -1 -1 -1  RSMH=1.50 1.50 1.50 1.50 
      EH2=-2 -2 -2 -2 RSMH2=1.50 1.50 1.50 1.50
      KMXA={kmxa}  LMX=3 LMXA=6 NMCORE=1
      IDU=0 0 0 12  UH=0 0 0 0.676  JH=0 0 0 0.0882
      IDMOD=0 0 0 1
      PZ=0,15.9,0,5.5
      MMOM=0 0 0 7 #s,p,d,f initial condition
...
% const pwemax=3 nk1=6 nk2=6 nk3=6 nit=30  gmax=12  nspin=2 metal=3 so=2 xcfun=1 ssig=0.8
BZ    ZBAK=3
