...
contains
  ...
  subroutine gwinit_v2() bind(C)
    ...
    write(ifi,'(a)') 'tetrakbt = true         # finite-T tetrahedron for X0 (method B-prime); supersedes SmearX0'
    write(ifi,'(a)') 't_tetrakbt = 300        # (K) electronic temperature for tetrakbt (default 300)'
