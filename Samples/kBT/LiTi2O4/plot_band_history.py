...
panels=[('june',it) for it in [1,2,3,4,6,7,10,17,18,20,45]]+[('today',it) for it in [1,2,3]]
...
fig.suptitle('LiTi2O4 9³ dq=0.1, 1000 K (tetrakbt + t_sigmakbt): O 2p bottom (bands 9–12 red) and near-E_F Ti t2g (green, bands 25–52) per QSGW iteration',fontsize=13)
fig.tight_layout(rect=(0,0,1,0.97)); fig.savefig('bands_history_999_T1000.png',dpi=80)
