...
--------
efermi.lmf 
is generated by lmf(lmf-MPI), which is used in the job_band.

----------------
New band plot and effective mass (curvature).
...
Here we do not use plbnd anymore. If necessary, you can modify
