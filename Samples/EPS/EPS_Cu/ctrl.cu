...
SPEC
    ATOM=Cu Z=29 R=2.33    
      EH=-1 -1 -1 -1  RSMH=1.17 1.17 1.17 1.17 
      EH2=-2 -2 -2  RSMH2=1.17 1.17 1.17 
...
% const pwemax=3 nk1=12 nk2=12 nk3=12 nit=30  gmax=12  nspin=1 metal=3 so=0 xcfun=1 ssig=1.0
