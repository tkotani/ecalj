subroutine toksw_init(debug)
  ...
  !      call tkadd(" STRUC_NSPEC")
  call tkadd(" OPTIONS~")
  call tkadd(" OPTIONS_FRZ~")
  call tkadd(" OPTIONS_HF~")
  call tkadd(" SPEC")
  call tkadd(sscale)
  !     call tkadd(" SPEC_SCLWSR~")
  !     call tkadd(" SPEC_WSRMAX~")
  !     call tkadd(" SPEC_OMAX1~")
  !     call tkadd(" SPEC_OMAX2~")
  ...
  !      call tkadd(" STR_ENV_NEL~")
  !      call tkadd(" STR_ENV_EL")
  ...
  call tkadd(" SYMGRPAF~")
  call tkadd(" STR~")
  !     call tkadd(" STR_DELRW~")
  !      call tkadd(" STR_EQUIV~")
  !     call tkadd(" STR_IINV~")
  !      call tkadd(" STR_LMAXW~")
  !      call tkadd(" STR_MODE~")
