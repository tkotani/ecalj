     ...
     .   eh , rsmh , ehl , rsml , rs3 , vmtz ,  lmaxu , vorb ,  !lcplxp ,
...
C ... Pkl*Pkl !tail x tail
      call gaugm ( nr , nsp , lso , rofi , rwgt , lmxa , lmxl !lcplxp , 
