...
> 先に求めて渡す実装が要る。**未実装。**
> 下表は `mlo_method = 0` に `mlo_emax` $=(\varepsilon_{\mathrm{CBM}}-E_F)+2.449$ eV を
> 与えて最終形を再現したもの。
...
| Cu (spd, 9) | 0.0457 | 0.0251 | 0.050 | −65 | 0.98 |
| Fe (spd, 9) | 0.0163 | 0.0166 | 0.046 | — | — |
| SrTiO₃ (15) | 0.0119 | 0.0207 | 0.017 | +28 | 1.14 |
| NiO (17) | 0.0222 | 0.0218 | 0.036 | +14 | 1.07 |
| Si (19) | 0.0157 | 0.0195 | 0.016 | +25 | 1.17 |
...
| **Al₂O₃:Cr (53)** | 0.0051 | **0.0175** | 0.006 | **+7** | **1.08** |
| **平均** | **0.0141** | **0.0167** | **0.022** | | |

§3 の $E_F$ 基準からの変化は Al₂O₃:Cr に集中する
(ギャップ誤差 −128 → **+7** meV、$m^*$ 比 0.58 → **1.08**、窓全体 0.0350 → **0.0175**)。
他の系はほぼ不変で、全体平均は窓全体 0.0184 → **0.0167** eV。
