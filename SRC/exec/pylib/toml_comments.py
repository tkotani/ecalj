...
SECTION_HEADER = {
    ...
    'iter': (
        ...
        "#       Both keep a history in __mixm.<sname>; delete it when you change",
        "#       the setup (nspin, xcfun, ...) so the new run does not inherit it.",
...
KEY_INLINE = {
    ...
    'gw': {
        ...
        't_tetrakbt':    "# (K) chi0 finite-T tetrahedron (method B-prime); 0 = off",
        't_sigmakbt':    "# (K) Fermi-Dirac occupations in Sigma; 0 = off (Gaussian esmr)",
        'wcsmear':       "# smear the pole position of Sigma_c's real-axis term with the esmr/kBT kernel",
        'SmearX0':       "# (Ha) Gaussian smearing of Im chi0 along omega; 0 = off (normally not needed)",
