python --version
python auto/jobsubmit.py --inpath INPUT/testSGA --epath ${HOME}/bin/ --nqsub 2 --ncore 64 --bnd4all True --niter 2 --gpu --mp
#python ./auto/jobsubmit.py --inpath INPUT/testSGA --epath ${HOME}/bin/ --nqsub 2 --ncore 16 --bnd4all True --niter 2 --kkmesh 4 4 4 3 3 3 
