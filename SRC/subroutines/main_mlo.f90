...
contains
  ...
  use mpi
  use m_HamPMT,only: ReadHamPMTInfo, HamPMTtoHamRsMLO, plat,npair,nlat,nqwgt,ldim,nkp,qplist,ib_table,alat,symops,ngrp,pos
  ...
  use m_mlo_ham, only: read_ham_rs, calc_ham_eigen, nspx, ndimMTO, npairmx
    ...
    GetHamiltonianFromRealSpacehammrANDdiagonalize: do ikp=iqini,iqend !1,ndatx
      ...
      Hamblock: block
        ...
        !   enddo FourierTransormationFROMrealspcaeTOqspace
          ...
          call calc_ham_eigen(qp, jsp, evl(:,ikp,jsp))
          !cbwf t_zv(:,ib)
