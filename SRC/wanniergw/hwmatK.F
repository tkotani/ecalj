...
c$$$c      read (if101,"(d24.16,3x, 3d24.16)" )( wqt(i),q0i(1:3,i),i=1,nq0i)
c$$$      nq0ix = nq0i
c$$$      do i=1,nq0i
c$$$      read (if101,* ) wqt(i),q0i(1:3,i)
...
c          call rwdd1 (ifev(is),iq, nwf,eq)
...
c     i     ngveccBr,
     ...
     i     matmul(symgg(:,:,irot),shtvg(:,invr)),nwf,
     i     ifvcfpout,
c     i     shtw, 
...
c write <p p | W | p p>
     ...
     i            alat,rcut1,rcut2,rw_w(:,:,:,:,:,0),cw_w(:,:,:,:,:,0))
      else
