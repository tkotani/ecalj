...
C      end
c$$$#if TEST
c$$$C Test program to check ropyln
c$$$      subroutine fmain
c$$$      implicit none
...
c$$$        enddo
c$$$      enddo
c$$$C     Test: Y_1-1 = sqrt(3/4/pi) y
c$$$C     print *, y(1) * dsqrt(0.75/4/atan(1d0))
c$$$C     print *, ylok(1,2)
c$$$
...
c$$$          i1 = l*l+1
c$$$          i2 = (l+1)**2
c$$$          print 333, (ylok(ir,ii),ii=i1,i2)
c$$$   12   continue
c$$$  333   format(9f8.5)
c$$$        print *
c$$$        do  14  l = 0, lmax
...
c$$$          i2 = (l+1)**2
c$$$          do  16  ii = i1, i2
c$$$            tops = max(tops,dabs(ylok(ir,ii)-ylv(ir,ii)))
c$$$   16     continue
c$$$          print 333, (ylok(ir,ii)-ylv(ir,ii),ii=i1,i2)
c$$$   14   continue
c$$$        print *, '----------------'
c$$$   10 continue
c$$$
