...
c      print *,' diagcvv: ngb,nev=',ngb,nev
c      do i=1,nev
c        write(6,'(i4,d23.16)')i, eb(i)
c      enddo
      end
...
c-----------------------------------------------------------------------------
c lapack driver routine
c http://www.netlib.org/lapack/complex16/zhegvx.f
c
