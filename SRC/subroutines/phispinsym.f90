subroutine phispinsym_ssite_set()
  ...
  !      type(s_site):: ssite(*) ssite(:) did not work (2021jun)
  ...
  !         print *,'111 ibas pnu=',ib,i_copy_size
  !         print *,'222 ibas pnu=',ssite(ib)%pnu(1:10)
  !         print *,'333 ibas pnu=',ssite(ib)%pnu(11:20)
