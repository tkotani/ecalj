...
#+TITLE: Effective Mass fitting test for ZB structure
#+AUTHOR: takao kotani @ tottori university, Japan
#+email: takaokotani@gmail.com

* For test, run 
./job 
This gives console output, which is in 'out' file.
...
See special lines in syml.init
--------------------
...
(it is not so simple in the usual standard text book; for exmaple, see

[1]A. N. Chantis, M. van Schilfgaarde, and T. Kotani, “Ab initio prediction of conduction 
band spin splitting in zinc blende semiconductors,” Phys. Rev. Lett., vol. 96, no. 8, p. 086405, Mar. 2006.
