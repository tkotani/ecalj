...
> measured accuracy of all 18 samples with band plots: **[MLO_minimal.md](MLO_minimal.md)**.
> Working records are under [notes/](notes/). Figures live in [plots/](plots/) and
> are regenerated by `SRC/exec/mlo_bandplot.py <sampledir>`.
