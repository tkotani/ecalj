module m_ropyln ! Normalized spheric harmonic polynomials (vectorizes).
  ...
  real(8), parameter :: f2m(0:24) = [ 0.1000000000000000D+01, & !l=0
    ...
    0.2952327990396042D+39, 0.3719933267899013D+42, 0.5230226174666012D+45, 0.8159152832478978D+48,&
    1.40500611775288d+51,2.658271574788449d+54,5.502622159812089d+57,1.2413915592536073d+61]
  ! pfff = (2(m-1)+1)!! = (2m+1)!!
