...
subroutine winfo(ifi,nspin,nq,ntq,is,nbloch,ngp,ngc,nqbz,nqibz,ef,deltaw,alat,esmr)
  implicit none
  integer :: ifi,nspin,nq,ntq,is,nbloch,ngp,ngc,nqbz,nqibz
...
subroutine q0iwgt3(allq0i,symops,ngrp,wqt,q0i,nq0i, wgt0)  !! Get weight for each k-points near 0.  !! wgt0(irreducible-k, irotation)
  implicit none
  logical :: allq0i !if true --> all rot. incl., even equivivalent,   ! f false -> include only nonequivivalent rot.
  integer :: ixx,ix,i, ngrp,ig,nq0i
  real(8) :: q0(3,6),q0i(3,6),symops(3,3,ngrp),sym(3,3),sym2(3,3),qt(3), q0in(3,ngrp*nq0i), wgt0(nq0i,ngrp), wqt(nq0i)
  wgt0 = 1d0
  do i = 1,nq0i
     ixx = 0
     qt = q0i(:,i)
