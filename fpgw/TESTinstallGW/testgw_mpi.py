...
testname.append(testn)
startfile.append('ctrl.si GWinput')
commands.append(['lmfa si > llmfa','gwsc1shot_mpi -np '+ mpisize +' si'])
datadir  = testdir+ '/' + testn+'/'
...
testname.append(testn)
startfile.append('ctrl.gas GWinput')
commands.append(['lmfa gas > llmfa','gwsc1shot_mpi -np '+ mpisize +' gas'])
datadir  = testdir+ '/' + testn+'/'
...
commands.append(['lmfa nio > llmfa','gwsc1shot_mpi -np '+ mpisize +' nio'])
datadir  = testdir+ '/' + testn+'/'
