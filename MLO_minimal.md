...
- **FeMgO** — **空格子球を入れて解決した。**
  ...
  **本数を 1.7 倍にして 0.6 meV しか改善しない**。
  ...
  ミニマル模型としては **s のみ**が最良のコストパフォーマンスである。
...
左(空格子球なし)では $E_F$ の上 $+0.5$〜$4$ eV の灰線に赤 × が乗っていない。
  ...
  **右の 3 枚(s,p,d / s,p / s のみ)はほとんど区別がつかない** — 141 本を 85 本まで
  減らしても絵が変わらない。空格子球の p と d が効いていないことが図からも読める。
