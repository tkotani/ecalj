...
subroutine show_programinfo(io)
  ...
  character(256):: PF=""
  character(256):: LL=""
  character(512):: GC1="commit e0f8082ee47f53a0a388d6cf4e694b42c06ae234"
  character(512):: GC2="Merge: d90414c6 9ce35e72"
  character(512):: GC3="Author: Takao Kotani <takaokotani@gmail.com>"
  ...
  write(io,'(a,a,a)') info,'linked at ',trim("Fri Mar  1 12:33:52 JST 2024")
