# MLO 自動窓 v6.3 — バンドフィッティング検証

ecalj branch `mlo3` / MLOsamples 15 系 / 2026-09-12
手調整パラメータゼロの固定設定による MLO 構成の検証レポート(v6 → v6.2 → v6.3 の到達点)。
...
**v6.3 の重み(二段 θ̄: hard freeze + soft tail)**:
...
=\max\!\bigl(\epsilon_{\,n_{\mathrm{occ}}+3},\;\epsilon_{\mathrm{frz}},\;
...
## 3. v6.3 総合評価([占有, CBM+3eV] 窓)

| 系 | rms (eV) | p95 (eV) | gap 誤差 (eV) | m\*(VBM) | m\*(CBM) |
|----|------:|------:|------:|------:|------:|
| Al₂O₃:Cr | **0.017** | 0.039 | −0.021 | 0.98 | **1.02** |
| RuO₂ | 0.015 | 0.029 | — | 1.06 | 0.29† |
| FeCo | 0.008 | 0.012 | — | — | 0.99 |
| GdCo5 / GdION | 0.001 / 0.000 | | — | (平坦 4f: 指標対象外) | |
| SrTiO₃ | 0.031 | 0.067 | +0.021 | 1.05 | — |
| GaAs | 0.032 | 0.069 | +0.027 | — | — |
| Fe | 0.033 | 0.060 | — | 1.16 | 1.12 |
| SmP | 0.041 | 0.111 | — | (平坦 4f) | |
| C.sp | 0.050 | 0.107 | +0.021 | — | 0.69† |
| FeMgO (slab) | **0.052** | 0.048 | — | 1.00 | — |
| NiO | 0.059 | 0.134 | +0.010 | 0.80 | 0.98 |
| Si 6³ (QSGW) | 0.070 | 0.164 | +0.165 | — | 2.75† |
| C | 0.073 | 0.148 | −0.140 | — | 0.36† |
| Cu | 0.164 | 0.350 | — | 1.45 | — |
...
## 5. バンドプロット(灰線: 第一原理 PMT、赤×: v6.3-MLO)
