subroutine potpus(z,rmax,lmxa,v,vdif,a,nr,nsp,lso,rofi,pnu,pnz, &
  ...
  !o Outputs
  !o   pp    :potential parameters pp(l+1,isp,j):
  !o         :(1): enu   linearization energies corresponding to input pnu
  !o         :(2): c     band center of gravity
  !o         :(3): srdel band width parameter
  !o         :(4): qpar  band distortion parameter
  !o         :(5): ppar  small parameter = integral phidot**2
  !o   ppnl  :NMTO pot pars (but no backward extrapolation; <phi phi>=1)
  !o         :(1)  = inverse potential function (not created)
