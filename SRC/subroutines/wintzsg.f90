! module m_purewintz: dead 2026-06-03 (no `use m_purewintz` anywhere in SRC).
! The free-standing `subroutine wintzsg_npm_wgtim` below (called externally)
! is the live entry; this in-module pure variant has no callers.
