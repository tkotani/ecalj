...
Fe(9 MTO = sp³d⁵)。majority と minority を並べた。**両スピンとも同等に乗る**:

| Fe | $\delta E_{\rm win}$ | $\delta E_{\rm occ}$ | $\delta v/v$ |
|---|---:|---:|---:|
| majority | 19.8 meV | 12.9 meV | 0.044 |
| minority | 17.1 meV | 18.4 meV | 0.025 |
...
| RuO₂ (26) 金属 | 1.8 (8.1) | 2.7 (9.5) | 1.8 (0.030) | — | — |
| Si $8^3$ (19) 絶縁 | 1.8 (5.7) | 2.7 (2.8) | 2.0 (0.005) | 2.0 (+2) | 2.7 (1.00) |
| GaAs (19) 絶縁 | 1.8 (7.4) | 2.0 (1.5) | 2.0 (0.008) | 1.4 (+1) | 2.0 (1.02) |
| Al₂O₃:Cr (53) 絶縁 | 2.0 (6.7) | 2.0 (2.2) | 2.0 (0.003) | 1.8 (+1) | 1.8 (1.03) |
...
DFT のエネルギーでビン分けした $\Delta E$ rms (meV):
...
| SrTiO₃ (15) | 5.4 | 12.4 | 0.009 | +17 | 1.07 |
| NiO (17) | 21.1 | 20.7 | 0.034 | +14 | 1.07 |
| Si (19) | 18.0 | 21.1 | 0.019 | +23 | 1.16 |
| C (spd, 19) | 10.1 | 17.9 | 0.009 | −6 | 1.00 |
| GaAs (19) | 12.3 | 17.3 | 0.011 | +26 | 1.00 |
| FeCo (20) | 6.4 | 5.9 | 0.013 | −3 | — |
| RuO₂ (26) | 9.1 | 8.9 | 0.030 | +0 | — |
| Al₂O₃:Cr (53) | 5.2 | 35.0 | 0.017 | **−128** | **0.58** |
| **平均** | **14.6** | **18.4** | **0.023** | | |
