...
$\exp(a)$, which is given be \verb+HistBin_ratio+.
...
For metal, our code can capture Drude weight numerically. 
We do not need to be so sensitive to the choice of them usually.
\underline{(WARNING! Some of my examples may show as if they are in "(Ry)". 
But they are Wrong!)}
