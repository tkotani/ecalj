...
calculation package availalbe freely.\\
...
ecalj/Document/Manual/). In \ecalj, we can do QSGW and related calculations
based on the PMT=LA\underline{P}W+L\underline{MT}O
method. To get minimum usage for ecalj, need to read up to Section .5
or Sec.\ref{cautionusage}. (We can generate model Hamiltonian thru
Wannier functions; not documented well yet...) \\
...
We have a script \io{ecalj/InsallAll.ifort} and so on.
