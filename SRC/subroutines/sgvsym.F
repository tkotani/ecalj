...
c      if (iprint() .ge. 20) call awrit2(' SGVSYM: %i symmetry stars'//
c     .' found for %i reciprocal lattice vectors',
c     .' ',80,stdo,nstar,ng)
      if (iprint() .ge. 20) write(stdo,"(' SGVSYM: ',i0,' symmetry stars found for ',
