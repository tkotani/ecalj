program lmfham1 ! Read HamiltonianPMT and generates MT-projected-orbital Hamiltonian <MPO|H|MPO> and overlap <MPO|MTPO>
  ...
  use m_HamRsMTO,  only: ReadHamRsMTO, hammr,ovlmr,ndimMTO, npairmx,nspx,ib_tableM
  ...
  call getkeyvalue("GWinput","mlo_ecutw",ecutw,default=2d0) !size of fixing inner window
