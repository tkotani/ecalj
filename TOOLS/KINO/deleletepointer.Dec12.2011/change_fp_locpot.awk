...
/^ .*rv_p_ov01/{
  ...
  gsub("rv_p_ov01[^a-zA-Z0-9]","ssite(ib)%rv_p_ov1")
...
/^ .*iv_p_ojcg/{
  ...
  gsub("iv_p_ojcg[^a-zA-Z0-9]","slat%iv_p_ojcg")
...
/^ .*iv_p_oidxcg/{
  ...
  gsub("iv_p_oidxcg[^a-zA-Z0-9]","slat%iv_p_oidxcg")
  if (match($0,"slat%slat%")) {next;}
}
/^ .*rv_p_ocg/{
  print comment,$0
  ...
  gsub("rv_p_ocg[^a-zA-Z0-9]","slat%rv_p_ocg")
  if (match($0,"slat%slat%")) {next;}
}
{print}
