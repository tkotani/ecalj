      ...
      integer:: iqread,iqindex job,ist,ip,ni,ix,ifi,jsp,ncount,iq,iband,i,j,nbandx,ig,iqindex
...
c      open(newunit=ifi,file='efermi.lmf') !readin fermi energy from efermi.lmf
c      read(ifi,*)  eferm
c      close(ifi)
